async function submitProductDetails(event) {
  ...
  window.addEventListener("DOMContentLoaded", async () => {
    try {
      const response = await axios.get("https://crudcrud.com/api/ee9cfe908e754750942d48031642bb41/inventoryDetails");
  ...
  async function createProduct(product) {
    try {
      const response = await axios.post("https://crudcrud.com/api/ee9cfe908e754750942d48031642bb41/inventoryDetails", product);
  ...
  async function deleteProduct(id) {
    try {
      const response = await axios.delete(`https://crudcrud.com/api/ee9cfe908e754750942d48031642bb41/inventoryDetails/${id}`);
      console.log(response);
    } catch (err) {
      console.log(err);
    }
